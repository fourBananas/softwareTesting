...
describe('At', () => {
    ...
    test('Should return array [1]', () => {
        expect(at(obj, ['a'])).toStrictEqual([1])
    });

    test('Should return array [[2, 3, 4]]', () => {
        expect(at(obj, ['b'])).toStrictEqual([[2,3,4]])
    });
    
    test('Should return array [[2, 3, 4], 5]', () => {
        expect(at(obj, ['b', 'c.d'])).toStrictEqual([[2,3,4], 5])
    });

    test('Should return array with undefined', () => {
